!(function (t, e) {
  ...
  class Z extends H {
    ...
    addBtn(t) {
      ...
      n.setAttribute("tabindex", "0"),
        ...
        T(n, this.cn("button") + " " + this.cn(t === Y ? "isNext" : "isPrev"));
      const s = i.isRTL ? (t === Y ? $ : Y) : t;
      var o;
      return (
  ...
  const q = { Navigation: Z, Dots: X, Sync: V },
    _ = "animationend",
    G = "isSelected",
    U = "slide";
  class K extends p {
        ...
        this.state === F.Ready &&
          (i.initialSlide =
            (null ===
              ...
              ? void 0
              : e.index) || 0),
        this.state !== F.Init && this.destroy(),
        super.setOptions(i),
    ...
    init() {
      (this.state = F.Init),
        this.emit("init"),
        this.attachPlugins(
          Object.assign(Object.assign({}, K.Plugins), this.userPlugins)
        ),
        this.emit("attachPlugins"),
        this.initLayout(),
        this.initSlides(),
    ...
    initSlides() {
      ...
      const e = [...this.slides],
        i = [];
      [...A(t, `.${this.cn(U)}`)].forEach((t) => {
        if (x(t)) {
          const e = I({ el: t, isDom: !0, index: this.slides.length });
          i.push(e);
        }
      });
      for (let t of [...(this.option("slides", []) || []), ...e]) i.push(I(t));
      this.slides = i;
    ...
    getSlideMetrics(t) {
      ...
      if (
        ...
        T(r, this.cn(U) + " " + t.class + " " + t.customClass),
        o)
      )
        (r.style[s] = `${o}px`),
    ...
    createSlideEl(t) {
      ...
      T(n, this.cn(U)), T(n, t.class), T(n, t.customClass);
      const s = t.html;
      s &&
    ...
    transitionTo(t = 0, e = this.option("transition")) {
      ...
      return (
        p &&
          ...
          (g.transition = e),
          p.addEventListener(_, this.onAnimationEnd),
          p.classList.add(`f-${e}Out`, `to-${c > 0 ? v : b}`)),
        m &&
          ((f.transition = e),
          m.addEventListener(_, this.onAnimationEnd),
    ...
    clearTransitions() {
      ...
      for (const e of this.slides) {
        const i = e.el;
        if (i) {
          i.removeEventListener(_, this.onAnimationEnd),
    ...
    updateMetrics() {
      ...
      (c = e(c, 1e3)),
        ...
        this.state === F.Init && this.setInitialPage(),
