...
@section('content')
            ...
            <div class="layout-px-spacing">
                <form action="{{url('/')}}/admin/countries/{{$item->id}}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-9 col-lg-9 col-sm-10">
                                                ...
                                                @if($item->flag)
                                                <a href="{{url('/')}}/storage/{{$item->flag}}" target="_blank">
                                                    <img class="image-form" src="{{url('/')}}/storage/{{$item->flag}}" alt="">
                                                </a>
                                                @endif
