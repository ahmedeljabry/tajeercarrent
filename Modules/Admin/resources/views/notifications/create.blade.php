            ...
            <div class="layout-px-spacing">
                <form  action="{{url('/')}}/admin/notifications" method="post" enctype="multipart/form-data">
                    ...
                    <div class="page__header_title custom__page_header_title">
                        ...
                        <button  class="btn btn-primary btn-rounded submit-btn">
                                ...
                                <div class="widget-content widget-content-area">
                                    <div class="row">
                                        ...
                                        <div class="form-group row mb-4">
                                            <label class="col-xl-3 col-sm-3 col-sm-2 col-form-label">{{__('admin.title')}}</label>
                                        ...
                                        <div class="form-group row mb-4">
                                            <label class="col-xl-3 col-sm-3 col-sm-2 col-form-label">{{__('admin.content')}}</label>
                                            <div class="col-xl-9 col-lg-9 col-sm-10">
