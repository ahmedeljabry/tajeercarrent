...
@section('content')
            ...
            <div class="layout-px-spacing">
                <form action="{{url('/')}}/admin/currencies/{{$item->id}}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    ...
                    <div class="row layout-spacing">
                      ...
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-9 col-lg-9 col-sm-10">
                            <input type="text" value="{{$item->name}}" required class="form-control" name="name" >
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-9 col-lg-9 col-sm-10">
                            <input type="text" value="{{$item->code}}" required class="form-control" name="code" >
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-xl-9 col-lg-9 col-sm-10">
                            <input type="number" value="{{$item->aed_rate}}" step="0.01" required class="form-control" name="aed_rate" >
                        </div>
                    </div>
