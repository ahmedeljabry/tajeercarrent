<div class="account-settings-card mb-3">
    <picture class="account-settings-card-main-picture" onclick="window.location.href='{{ LaravelLocalization::getLocalizedUrl(null, route('website.cars.show', ['car' => $car])) }}'">
    ...
    <div class="d-flex flex-column justify-content-between h-100 p-3">
        <div onclick="window.location.href='{{ LaravelLocalization::getLocalizedUrl(null, route('website.cars.show', ['car' => $car])) }}'"  >
            <a href="#">
                <h4>{{$car->name}}</h4>
            </a>
            <ul>
        ...
        <div class="rent-car-slide-footer ">
            <a href="https://wa.me/{{str_replace(['+', ' '], '', app('settings')->get('contact_phone'))}}?text={{urlencode("Hello I Am Interested On This Car, " . LaravelLocalization::getLocalizedUrl(null, route('website.cars.show', ['car' => $car])))}}" target="_blank" rel="nofollow noopener">
                <div>
